    ...
    u.prototype.view = function() {
        ...
        i = {
            ...
            batchOperation : function(){
            	var h = '<div class="layui-laypage-batch-operation">';
            		h += '<div class="layui-table-cell laytable-cell-checkbox" style="display: inline-block;width: 34px;vertical-align:middle;">';
            			h += '<input type="checkbox" name="layTableCheckbox" lay-skin="primary" lay-filter="layTableAllChoose">';
            		h += '</div>';
            		h += '<span style="margin-right: 10px;margin-bottom:0;">当页全选</span>';
            		h += $(a.batchOperation).html() + '</div>';
            	return a.batchOperation ? h : ""; 
            }(),
            page: function() {
                var e = [];
                if (a.count < 1 || a.pages <= 1) return "";
...
/*            limit: function() {
            ...
            limit: ['<span class="layui-laypage-limits">每页 ' + a.limit + '条</span>'],
    ...
    u.prototype.jump = function(e, a) {
        if (e) {
            ...
            i = t.config,
            r = e.children,
            u = e[n]("button")[e[n]("button").length-1],//开发者可以自行添加左侧的操作功能，为了避免获取错误，改成获取最后一个
            l = e[n]("input")[e[n]("input").length-1],
            p = e[n]("select")[e[n]("select").length-1],
            c = function() {
    ...
    u.prototype.skip = function(e) {
        if (e) {
            var a = this,
            t = e[n]("input")[e[n]("input").length-1];
            t && s.on(t, "keyup",
            function(t) {
                var n = this.value,
                i = t.keyCode;
