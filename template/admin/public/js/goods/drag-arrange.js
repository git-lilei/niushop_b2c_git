			...
			$.fn.arrangeable = function(options) {
				...
				function dragMoveHandler(e) {
					...
					if (dragging) {
						...
						if($dragElement.hasClass('spec-item')){
							$clone.css({
						...
						console.log($dragElement.css('margin-left'));
				...
				function dragEndHandler(e) {
					...
					if (dragging) {
						...
						$(dragElement).parent().trigger(dragEndEvent,
								[ $(dragElement) ]);
						$('.props-value').css("visibility",'inherit');
						
						if($(dragElement).hasClass('spec-value-item')){
							spec_sort('spec_value');
						}else{
							spec_sort('spec_name');
						}
