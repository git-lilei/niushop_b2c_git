...
// +----------------------------------------------------------------------
namespace addons\NsVirtualGoods;

use addons\NsVirtualGoods\admin\controller\Goods;

class NsVirtualGoodsAddon extends \addons\Addons
{
	
	public $info = array(
		'name' => 'NsVirtualGoods', // 插件名称标识
		'title' => '虚拟商品', // 插件中文名
		'description' => '虚拟商品支持核销管理', // 插件概述
		'status' => 1, // 状态 1启用 0禁用
		'author' => 'niushop', // 作者
		'version' => '1.0', // 版本号
		'has_addonslist' => 0, // 是否有下级插件 例如：第三方登录插件下有 qq登录，微信登录
		'content' => '', // 插件的详细介绍或使用方法
		'ico' => 'addons/NsVirtualGoods/ico.png'
	);
