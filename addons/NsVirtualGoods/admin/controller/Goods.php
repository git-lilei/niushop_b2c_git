...
namespace addons\NsVirtualGoods\admin\controller;
...
class Goods extends BaseController
{
	...
	{
		parent::__construct();
		$this->addon_view_path = ADDON_DIR . '/NsVirtualGoods/template/';
		$this->assign('addon_view_path', $this->addon_view_path . $this->style);
	}
