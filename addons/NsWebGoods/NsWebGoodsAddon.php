...
// +----------------------------------------------------------------------
namespace addons\NsWebGoods;
use addons\NsWebGoods\admin\controller\Goods;
class NsWebGoodsAddon extends \addons\Addons
{
	
	public $info = array(
		'name' => 'NsWebGoods', // 插件名称标识
		'title' => '网盘商品', // 插件中文名
		'description' => '提供网络虚拟化产品的购买交易', // 插件概述
		'status' => 1, // 状态 1启用 0禁用
		'author' => 'niushop', // 作者
		'version' => '1.0', // 版本号
		'has_addonslist' => 0, // 是否有下级插件 例如：第三方登录插件下有 qq登录，微信登录
		'content' => '', // 插件的详细介绍或使用方法
		'ico' => 'addons/NsWebGoods/ico.png'
	);
